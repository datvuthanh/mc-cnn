...
for _, dataset in ipairs({2012, 2015}) do
   ...
   for i, arg in ipairs(examples) do
      ...
      print("HEIGHT AND WIDTH OF IMAGES: " .. img_height .. "x" .. img_width)
      img_0 = img_0:narrow(2, img_height - height + 1, height) --crop to 350
      img_1 = img_1:narrow(2, img_height - height + 1, height) -- crop to 350
